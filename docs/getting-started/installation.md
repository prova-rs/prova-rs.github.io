...
- `prova-<version>-linux-x86_64.tar.gz`
- `prova-<version>-linux-arm64.tar.gz`
- `prova-<version>-macos-arm64.tar.gz`
- `prova-<version>-windows-x86_64.zip` (plus a `-installer.exe`)
...
sudo mv prova-$VERSION-linux-x86_64/prova /usr/local/bin/
```
